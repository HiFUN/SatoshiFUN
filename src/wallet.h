...
public:
    ...
    void GeHIFUNounts(int64& nGeneratedImmature, int64& nGeneratedMature, std::list<std::pair<CTxDestination, int64> >& listReceived,
                    std::list<std::pair<CTxDestination, int64> >& listSent, int64& nFee, std::string& strSentAccount) const;

    void GetAccounHIFUNounts(const std::string& strAccount, int64& nGenerated, int64& nReceived,
